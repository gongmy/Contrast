        ...
        public Hashtable upFile(HttpContext cxt, string pathbase, string[] filetype, int size)
        {
            ...
            try
            {
                ...
                if (state == "SUCCESS")
                {
                    ...
                    ToolImage.SuperGetPicThumbnail(img, uploadpath + filename, 70, 800, 0, System.Drawing.Drawing2D.SmoothingMode.HighQuality, System.Drawing.Drawing2D.CompositingQuality.HighQuality, System.Drawing.Drawing2D.InterpolationMode.High);
